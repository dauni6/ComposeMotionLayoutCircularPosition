package com.dontsu.composemotionlayoutcircularposition
...
import com.dontsu.composemotionlayoutcircularposition.ui.theme.ComposeMotionLayoutCircularPositionTheme
...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ComposeMotionLayoutCircularPositionTheme {
                Surface(
